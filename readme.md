...
+ 1주차
  + css 라이브러리 사용해보기, 라이브 러리를 이용한 페이지코딩.
  + 제이쿼리 사용해보기, 제이쿼리 문법 파해치기, 제이쿼리를 이용하여 간단한 애니메이션 만들어보기
...
## 3달
+ 1주차
  + css 방법론 (BEM, OOCSS)훑어보기, 방법론 이용하여 코딩해보기
...
+ 1주차
  ...
  + 클론 한 홈페이지 코드리뷰(동영상 메인, 타이포 애니메이션)
    + scss 이용하여 반응형 페이지 코딩(스크롤 애니메이션, 타이포 애니메이션)
+ 2주차
...
+ 4주차
  ...
  + 파이널 프로젝트 코드리뷰 및 보안점 확인. 
    + 숙제 = 본인이 프로젝트한 파일, 설명, 포트폴리오화하여 ppt 만들기 이력서 업로드하기. 구매한 js 도서 훝어보기.
